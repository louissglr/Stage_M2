...
# UMAP avec ordre 9 → 1
umap <- DimPlot(seurat, reduction = "umap", group.by = "pattern_cogaps_visual", label = TRUE, pt.size = 0.5) +
...
# Assemblage final avec tags A et B sur umap et barplot
...
# Sauvegarde
ggsave(
  filename = "C:/Users/louis/Desktop/Stage/scrnaseq_final/script/Plot_Rapport/cogaps_UMAP.png",
  plot = panel,
  width = 13,
  height = 6,
  dpi = 300
