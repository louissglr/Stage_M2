...
# UMAP avec couleurs correctes des clusters (ordre naturel), labels en blanc et plus grands
umap <- DimPlot(seurat, reduction = "umap", group.by = "seurat_clusters", label = TRUE, pt.size = 0.5, label.color = "white", label.size = 10) +
...
# Assemblage final sans les labels A, B, ...
...
# Sauvegarde
ggsave(
  filename = "C:/Users/louis/Desktop/Stage/scrnaseq_final/script/Plot_Diapo_Black/seurat_UMAP.png",
  plot = panel,
  width = 13,
  height = 6,
  dpi = 300,
