...
seurat <- readRDS("C:/Users/louis/Desktop/Stage/scrnaseq_final/output/21_AddCoGAPSToSeuratCancer/seurat_cogaps_res_8p.rds")
...
# Sauvegarde
ggsave(
  filename = "C:/Users/louis/Desktop/Stage/scrnaseq_final/script/Plot_Diapo_Black/cogaps_UMAP_cancer.png",
  plot = panel,
  width = 13,
  height = 6,
  dpi = 300,
