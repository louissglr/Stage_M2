...
seurat <- readRDS("C:/Users/louis/Desktop/Stage/scrnaseq_final/output/09_AddCoGAPSToSeurat/seurat_cogaps_res_10p.rds")
...
p <- DimPlot(seurat, reduction = "umap", group.by = "pattern_cogaps", label = TRUE, label.color = "white") +
  theme_minimal() +
  theme(
    panel.background = element_rect(fill = "black", color = NA),
    plot.background = element_rect(fill = "black", color = NA),
